...
function getInventary() {
    ...
    //prepare request
    x.open('GET', 'http://localhost/abarrotesStep/controllers/inventarioController.php', true);
    //send request
    x.send();
...
function getInventaryByFilter() {
    var first = true;
    var url = "http://localhost/abarrotesStep/controllers/inventarioController.php"
