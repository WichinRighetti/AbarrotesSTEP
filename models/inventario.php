...
class Inventario
{
    ...
    //setters & getters
    public function setInventario_id($value)
    {
        $this->inventario_id = $value;
    }
    public function getInventario_id()
    {
        return $this->inventario_id;
    }
    public function setProducto_id($value)
    {
    ...
    public function setAlmacen_id($value)
    {
    ...
    public function setNombre_almacen($value)
    {
        $this->nombre_almacen = $value;
    }
    public function getNombre_almacen()
    {
