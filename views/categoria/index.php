...
<head>
    ...
    $categorias = json_decode(Categoria::getAllByJson(), true);
    ?>
<body>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group align-top">
                                                                <button class="btn btn-sm btn-outline-secondary" type="button" onclick="getCategory(<?php echo $categoria['categoria_id']?>)" data-toggle="modal" data-target="#user-form-modal">Edit</button>
