...
$almacenesTotales = json_decode(Almacen::getAllByJson(), true);
$elementosPorPagina = 20;
$totalProductos = count($almacenesTotales);
...
$almacenes = json_decode(Almacen::getAllPaginaByJson($iniciar, $elementosPorPagina), true);
?>
<body>
                        ...
                        <div class="e-panel card">
                            <div class="card-body">
                                <div class="card-title">
                                    <h6 class="mr-2"><span>Almacenes</span></h6>
                                </div>
                                <div class="e-table">
                                    <div class="table-responsive mt-3">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody id="almacenes-table-body">
                                                <!-- Aqu� puedes llenar la tabla con los datos de los almacenes -->
                                                <?php foreach ($almacenes as $almacen) : ?>
                                                    <tr>
                                                        <td class="align-middle">
                                                            <div class="custom-control custom-control-inline custom-checkbox custom-control-nameless m-0 align-top">
                                                                <input type="checkbox" class="custom-control-input" id="item-<?php echo $almacen['almacen_id']; ?>">
                                                                <label class="custom-control-label" for="item-<?php echo $almacen['almacen_id']; ?>"></label>
                                                            </div>
                                                        </td>
                                                        <td><?php echo $almacen['almacen_id']; ?></td>
                                                        <td><?php echo $almacen['nombre']; ?></td>
                                                        <td><?php echo $almacen['descripcion']; ?></td>
                                                        <td><?php echo $almacen['direccion']; ?></td>
                                                        <td>
                                                            <div class="btn-group align-top">
                                                                <button class="btn btn-sm btn-outline-secondary" type="button" onclick="getWarehouse(<?php echo $almacen['almacen_id']?>)" data-toggle="modal" data-target="#user-form-modal">Edit</button>
                                                                <button class="btn btn-sm btn-outline-secondary deactivate-product" type="button" onclick="deleteWarehouse(<?php echo $almacen['almacen_id']?>)"><i class="fa fa-trash"></i></button>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <div class="form-group">
                                        ...
                                        <div><input class="form-control w-100" type="text" placeholder="Name" id="txtNombre" onchange="getCategoriesByFilter()"></div>
                                    </div>
                                </div>
                                <hr class="my-3">
                                <div>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="py-1">
                                    <form action="../../controllers/almacenController.php" method="POST" class="form" novalidate>
                                        <div class="row">
                                            <div class="col">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            <input id="almacen_id" class="form-control" type="hidden" name="almacen_id" value="">
                                                            <label>Nombre</label>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="descripcion" class="form-control" type="text" name="descripcion" placeholder="Demo" value="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="direccion" class="form-control" type="text" name="direccion" placeholder="Demo" value="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
