...
<?php
    ...
    $subcategoriasTotales = json_decode(Subcategoria::getAllByJson(), true);
    $elementosPorPagina = 20;
    $totalProductos = count($subcategoriasTotales);
    ...
    $subcategorias = json_decode(Subcategoria::getAllPaginaByJson($iniciar, $elementosPorPagina), true);
?>
<body>
